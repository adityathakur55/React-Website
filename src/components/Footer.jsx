  ...
  return (
    <div className='w-full h-screen bg-zinc-900 p-20 flex '>
      <div className='w-1/2 h-full flex flex-col justify-between '>
        ...
        <h1 className='text-[7.5vw] uppercase font-semibold leading-none -mb-4 font-sans'>Eye-</h1>
        <h1 className='text-[6.5vw] uppercase font-semibold leading-none -mb-4 font-sans'>Opening</h1>
      </div>
      ...
      <div className='w-1/2 h-full relative '>
        <h1 className='text-[7vw] uppercase absolute font-semibold tracking-tight font-sans leading-none -mb-4  '>Presentation</h1>
        <div className='dets mt-[30vh]  flex flex-col'>
          <a className='text-5xl underline font-light ' href="#">Facebook 
            <FacebookIcon className='' style={{fontSize:100} }/>
          </a>
          <a className='text-5xl underline font-light  ' href="#">Instagram
            <InstagramIcon className='' style={{fontSize:100, color: 'pink'}} />
          </a>
          <a className='text-5xl underline font-light   ' href="#">Twitter
            <TwitterIcon className='' style={{fontSize:100, color: 'blue'}} />
          </a>
        </div>
      </div>
    </div>
